<template>
  <div class="mail-lover">
	<p class="mail-lover-id"><span></span>出版精品</p>
...
export default {
	...
	methods: {
		get(){
		axios.get('http://novel.juhe.im/category-info?gender=press&type=reputation&major=出版小说&minor=&start=0&limit=3').then(res=>{
